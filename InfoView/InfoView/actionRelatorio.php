...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO relatorio (idUsuario, idCurso, ano, semana, mes, dia, idDisciplina, descricao) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    // Liga os parâmetros
    mysqli_stmt_bind_param($stmt, 'iiisssis', $_SESSION['idUsuario'], $curso, $ano, $semana, $mes, $dia, $disciplina, $descricao);
