...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento){
            ...
            $inserirUsuario = "INSERT INTO Usuarios (emailUsuario, senhaUsuario) VALUES ('$emailUsuario', '$senhaUsuario')";
            ...
            if(mysqli_query($conn, $inserirUsuario)){
                echo "
                    <div class='alert alert-success text-center'><strong>Usuário</strong> logado com sucesso!</div>
                ...
                echo "<div class='alert alert-danger text-center'>Erro ao logar<strong>Usuário</strong></div>" . mysqli_error($conn);
            }
